...
const buttonBaseStyles = tv({
	base: "text-primary-fg focus-visible:ring-primary inline-flex cursor-pointer select-none items-center justify-center overflow-hidden rounded-lg font-medium transition-all focus-visible:outline-none focus-visible:ring-1 disabled:pointer-events-none disabled:opacity-50",
	variants: {
		variant: {
			...
			outline:
				"border-secondary-border bg-secondary-bg hover:border-primary-border hover:bg-secondary-bg-hover border border-solid shadow-sm",
			ghost: "hover:bg-secondary-bg-hover bg-transparent",
			link: "text-muted hover:text-primary-fg bg-transparent underline",
			text: "text-muted hover:text-primary-fg bg-transparent"
		},
		status: {
			default: "",
