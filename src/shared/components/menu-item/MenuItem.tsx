...
export const menuItemStyles = tv({
	base: [
		"group/menu-item relative flex min-h-10 cursor-pointer select-none items-center gap-2 rounded-sm bg-secondary-bg p-2 py-1.5 text-sm text-primary-fg lg:min-h-8",
