...
>(({ className, inset, children, ...props }, ref) => {
	...
	const styles = documentMenuSubTriggerStyles({ inset, theme });
...
>(({ className, ...props }, ref) => {
	...
	return (
		<DropdownMenuPrimitive.SubContent
			ref={ref}
			className={documentMenuSubContentStyles({ className, theme })}
			{...props}
		/>
	);
});
	...
	return (
		<DropdownMenuPrimitive.Portal container={container}>
			<DropdownMenuPrimitive.Content
				...
				className={dropdownMenuContentStyles({ theme, className })}
				{...props}
			/>
...
>(({ className, disabled, inset, children, ...props }, ref) => {
	...
	return (
		<DropdownMenuPrimitive.Item
			ref={ref}
			disabled={disabled}
			className={dropdownMenuItemStyles({ className, disabled, inset, theme })}
			{...props}
		>
			{children}
		</DropdownMenuPrimitive.Item>
...
>(({ className, children, checked, disabled, ...props }, ref) => {
	const { variant: theme } = useComponentVariant();
	const styles = dropdownMenuCheckboxItemStyles({ checked, theme, disabled });
...
>(({ className, children, disabled, ...props }, ref) => {
	...
	const styles = dropdownMenuRadioItemStyles({ theme, disabled, className });
...
>(({ className, inset, ...props }, ref) => {
	...
	return (
		<DropdownMenuPrimitive.Label
			ref={ref}
			className={dropdownMenuLabelStyles({ inset, className, theme })}
			{...props}
		/>
	);
});
...
>(({ className, ...props }, ref) => {
	...
	return (
		<DropdownMenuPrimitive.Separator
			ref={ref}
			className={dropdownMenuSeparatorStyles({ className, theme })}
			{...props}
		/>
	);
});
...
const DropdownMenuShortcut = ({ className, ...props }: React.HTMLAttributes<HTMLSpanElement>) => {
	...
	return <span className={dropdownMenuShortcutStyles({ className, theme })} {...props} />;
};
