...
const tagInputStyles = tv({
	...
	base: "group/search-select-trigger flex h-auto min-h-10 flex-wrap items-center gap-1 p-1.5 lg:h-auto lg:min-h-9 lg:p-1.5"
});

const inputStyles = tv({
	base: "min-w-16 rounded-none p-0 px-1.5 pl-0 read-only:w-0 read-only:min-w-0 lg:p-0 lg:px-1.5 lg:pl-0"
});
...
export const TagInput = React.forwardRef<HTMLDivElement, TagInputProps>(
	(
		...
		const styles = tagInputStyles({ className });
